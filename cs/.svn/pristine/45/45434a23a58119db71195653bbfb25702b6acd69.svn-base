...
<body onload="init()">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class="active"><a href="index.jsp"><span class="glyphicon glyphicon-dashboard"></span>商品管理</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
        ...
        <div class="row">
			<form class="form-horizontal" role="form" method="post" action="addBook">
			  <div class="form-group">
