...
<body onload="init()">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class="active"><a href="salesadd.jsp"><span class="glyphicon glyphicon-dashboard"></span>销售录入</a></li>
		</ul>
	</div><!--/.sidebar-->
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">销售录入</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header">销售录入</h3>
			</div>
		</div><!--/.row-->
		
        <div class="row">
			<form class="form-horizontal" role="form" method="post" action="addSales">
			  <div class="form-group">
